...
class ddpg_agent(object):
	...
	def create_actor_network(self,inputdims,outputdims):
		...
		c.add(Dense(40,outputdims,stddev=1))
	...
	def create_critic_network(self,inputdims,actiondims):
		...
		den0 = c.add(d(inputdims, 160))

		den1 = c.add(d(160 + actiondims,80))
		den2 = c.add(d(80,40))
		den2a = c.add(d(40,20))
		den3 = c.add(Dense(20,1,stddev=1))
