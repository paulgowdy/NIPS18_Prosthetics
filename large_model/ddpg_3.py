...
class ddpg_agent(object):
	...
	def create_critic_network(self,inputdims,actiondims):
		...
		den0 = c.add(d(inputdims, 1000))

		den1 = c.add(d(1000 + actiondims,800))
		den2 = c.add(d(800,600))
		den2a = c.add(d(600,300))
		den3 = c.add(Dense(300,1,stddev=1))
