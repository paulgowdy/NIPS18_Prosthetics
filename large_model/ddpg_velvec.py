...
class ddpg_agent(object):
	...
	def create_actor_network(self,inputdims,outputdims):
		...
		with tf.device('/device:GPU:0'):
			...
			c.add(Dense(1000,outputdims,stddev=1))
	...
	def create_critic_network(self,inputdims,actiondims):
		...
		with tf.device('/device:GPU:0'):
			...
			den0 = c.add(d(inputdims, 2000))

			den1 = c.add(d(2000 + actiondims,1800))
			den2 = c.add(d(1800,1600))
			den2a = c.add(d(1600,600))
			den3 = c.add(Dense(600,1,stddev=1))
...
if __name__=='__main__':
	...
	def train(eps, save_interval = 100, frameskip = 3):
